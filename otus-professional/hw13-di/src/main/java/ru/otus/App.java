...
import ru.otus.config.splited.AppConfig1;
import ru.otus.config.splited.AppConfig2;
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        AppComponentsContainer container = new AppComponentsContainerImpl("ru.otus.config.splited");
